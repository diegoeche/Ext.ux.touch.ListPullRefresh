The fork simply removes some unnecessary stuff to just get it working
with Sencha touch panels.

The previous version worked only once when inserted in the panel.

I also removed some of the animations because they were throwing some errors.
